...
export const ProductDevelopment = () => {
  const product1 = {
    title: "",
    description:
      "Weather Forecast Voice AI Agent provides real-time weather updates, forecasts, and alerts through an interactive voice-based assistant..",
    url: "https://weather-ai-agent-frontend.vercel.app/",
    thumbnail: "/assets/wheatherai.png", // Replace with the actual logo/image URL
    buttonLabel: "Visit Product URL",
    highlightUrl: "https://youtu.be/TsslPpZVHF8​", // No highlight for this card
  };
  ...
  const product2 = {
    ...
    buttonLabel: "Visit Product URL",
    highlightUrl: "https://youtu.be/IYHl5nUxFbY",
  };
